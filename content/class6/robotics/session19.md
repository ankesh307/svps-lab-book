# Session 19: Generating GCode files

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Generating GCode files](https://images.unsplash.com/photo-1581092162384-8987c1d64718?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Exporting sliced models Gcode to SD card for printer.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `GCode Export` | `SD Card` | `3D Printing`
...
### Core Concept
Exporting sliced models Gcode to SD card for printer.

### Component Specifications
* **Key Device:** Generating GCode files
* **Usage Parameter:** GCode Export / SD Card / 3D Printing
...
**Q2.** What is the purpose of `GCode Export`?
