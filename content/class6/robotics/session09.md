# Session 09: Web Relay switch logic

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Web Relay switch logic](https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Clicking website button redirects to digital toggle endpoint... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Web Switch` | `HTTP Toggle` | `Relay`
...
### Core Concept
Clicking website button redirects to digital toggle endpoints.

### Component Specifications
* **Key Device:** Web Relay switch logic
* **Usage Parameter:** Web Switch / HTTP Toggle / Relay
...
**Q2.** What is the purpose of `Web Switch`?
