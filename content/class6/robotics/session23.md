# Session 23: HC-SR04 Trigger Echo

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![HC-SR04 Trigger Echo](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Sound waves transit time duration calculations.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `HC-SR04` | `TRIG/ECHO` | `Sound speed`
...
### Core Concept
Sound waves transit time duration calculations.

### Component Specifications
* **Key Device:** HC-SR04 Trigger Echo
* **Usage Parameter:** HC-SR04 / TRIG/ECHO / Sound speed
