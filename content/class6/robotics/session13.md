# Session 13: Python While & For Loops

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Python While & For Loops](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Infinite loop (while True) and iteration ranges loops.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `while True` | `for range()` | `Python Loops`
...
### Core Concept
Infinite loop (while True) and iteration ranges loops.

### Component Specifications
* **Key Device:** Python While & For Loops
* **Usage Parameter:** while True / for range() / Python Loops
...
**Q2.** What is the purpose of `while True`?
