# Session 11: Python Print Math input

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Python Print Math input](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Learn simple python math, variables, and output commands.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Print Math` | `Python Math` | `Command line`
...
### Core Concept
Learn simple python math, variables, and output commands.

### Component Specifications
* **Key Device:** Python Print Math input
* **Usage Parameter:** Print Math / Python Math / Command line
