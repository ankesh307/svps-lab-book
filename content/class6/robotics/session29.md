# Session 29: MPU6050 Accelerometer

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![MPU6050 Accelerometer](https://images.unsplash.com/photo-1517055720413-77a282b11dd9?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | I2C SDA/SCL raw acceleration data reading cycles.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `MPU6050` | `I2C raw data` | `Accelerometer`
...
### Core Concept
I2C SDA/SCL raw acceleration data reading cycles.

### Component Specifications
* **Key Device:** MPU6050 Accelerometer
* **Usage Parameter:** MPU6050 / I2C raw data / Accelerometer
...
**Q2.** What is the purpose of `MPU6050`?
