# Session 27: Reading RFID card UID

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Reading RFID card UID](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | MFRC522 library read card type, parse Hex UID strings.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `MFRC522` | `Hex UID` | `RFID card`
...
### Core Concept
MFRC522 library read card type, parse Hex UID strings.

### Component Specifications
* **Key Device:** Reading RFID card UID
* **Usage Parameter:** MFRC522 / Hex UID / RFID card
...
**Q2.** What is the purpose of `MFRC522`?
