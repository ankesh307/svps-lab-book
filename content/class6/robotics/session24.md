# Session 24: Ultrasonic Distance math

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Ultrasonic Distance math](https://images.unsplash.com/photo-1517055720413-77a282b11dd9?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Distance = (duration / 2) * 0.0343 speed of sound math.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Distance math` | `speed of sound` | `pulseIn`
...
### Core Concept
Distance = (duration / 2) * 0.0343 speed of sound math.

### Component Specifications
* **Key Device:** Ultrasonic Distance math
* **Usage Parameter:** Distance math / speed of sound / pulseIn
...
**Q2.** What is the purpose of `Distance math`?
