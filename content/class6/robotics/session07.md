# Session 07: ESP8266WebServer class

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![ESP8266WebServer class](https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Instantiate server class object, server.on() endpoints.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `ESP8266WebServer` | `server.on()` | `HTTP`
...
### Core Concept
Instantiate server class object, server.on() endpoints.

### Component Specifications
* **Key Device:** ESP8266WebServer class
* **Usage Parameter:** ESP8266WebServer / server.on() / HTTP
...
**Q2.** What is the purpose of `ESP8266WebServer`?
