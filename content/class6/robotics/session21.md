# Session 21: BO Gear Motor Power Map

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![BO Gear Motor Power Map](https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Why L298N needs separate battery power line from board.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Power Line` | `Battery Split` | `L298N`
...
### Core Concept
Why L298N needs separate battery power line from board.

### Component Specifications
* **Key Device:** BO Gear Motor Power Map
* **Usage Parameter:** Power Line / Battery Split / L298N
...
**Q2.** What is the purpose of `Power Line`?
