# Session 26: SPI Bus RC522 RFID

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![SPI Bus RC522 RFID](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | MOSI, MISO, SCK and SS pins mapping on ESP8266.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `SPI Bus` | `RC522 RFID` | `MOSI/MISO`
...
### Core Concept
MOSI, MISO, SCK and SS pins mapping on ESP8266.

### Component Specifications
* **Key Device:** SPI Bus RC522 RFID
* **Usage Parameter:** SPI Bus / RC522 RFID / MOSI/MISO
...
**Q2.** What is the purpose of `SPI Bus`?
