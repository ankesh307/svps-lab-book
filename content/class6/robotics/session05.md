# Session 05: Connecting Local WiFi

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Connecting Local WiFi](https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | WiFi.begin(ssid, password) connection loops status check.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `WiFi.begin()` | `SSID/PASS` | `WiFi Loop`
...
### Core Concept
WiFi.begin(ssid, password) connection loops status check.

### Component Specifications
* **Key Device:** Connecting Local WiFi
* **Usage Parameter:** WiFi.begin() / SSID/PASS / WiFi Loop
...
**Q2.** What is the purpose of `WiFi.begin()`?
