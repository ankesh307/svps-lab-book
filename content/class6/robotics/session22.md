# Session 22: ESP8266 Car steering
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Differential drive steering logic for left/right turns.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Differential Drive` | `Steering` | `Dual Motor`
...
### Core Concept
Differential drive steering logic for left/right turns.

### Component Specifications
* **Key Device:** ESP8266 Car steering
* **Usage Parameter:** Differential Drive / Steering / Dual Motor
...
**Q2.** What is the purpose of `Differential Drive`?
