# Session 28: Smart Gate Lock Control

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Smart Gate Lock Control](https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Matching card UID unlocks Servo gate lock mechanism.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `RFID Gate` | `Servo Lock` | `Access Control`
...
### Core Concept
Matching card UID unlocks Servo gate lock mechanism.

### Component Specifications
* **Key Device:** Smart Gate Lock Control
* **Usage Parameter:** RFID Gate / Servo Lock / Access Control
...
**Q2.** What is the purpose of `RFID Gate`?
