# Session 25: Obstacle Avoider loop

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Obstacle Avoider loop](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Braking, turning left, checking clear paths logic.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Obstacle Avoid` | `Auto Brake` | `Turn`
...
### Core Concept
Braking, turning left, checking clear paths logic.

### Component Specifications
* **Key Device:** Obstacle Avoider loop
* **Usage Parameter:** Obstacle Avoid / Auto Brake / Turn
...
**Q2.** What is the purpose of `Obstacle Avoid`?
