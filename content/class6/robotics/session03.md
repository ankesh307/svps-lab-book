# Session 03: Installing ESP8266 Core

**Class 6 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Installing ESP8266 Core](https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Arduino IDE Additional Boards Manager URL insertion process.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Board Manager` | `ESP8266 URL` | `IDE Setup`
...
### Core Concept
Arduino IDE Additional Boards Manager URL insertion process.

### Component Specifications
* **Key Device:** Installing ESP8266 Core
* **Usage Parameter:** Board Manager / ESP8266 URL / IDE Setup
...
**Q2.** What is the purpose of `Board Manager`?
