# Session 16: MPU6050 I2C registers

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![MPU6050 I2C registers](https://images.unsplash.com/photo-1517055720413-77a282b11dd9?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Reading raw linear acceleration and angular velocity registe... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `MPU6050` | `I2C registers` | `Raw values`
...
### Core Concept
Reading raw linear acceleration and angular velocity registers.

### Component Specifications
* **Key Device:** MPU6050 I2C registers
* **Usage Parameter:** MPU6050 / I2C registers / Raw values
