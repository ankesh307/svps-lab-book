# Session 06: Bambu Studio CAD import

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Bambu Studio CAD import](https://images.unsplash.com/photo-1581092162384-8987c1d64718?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | STL orientation scaling parameters inside slicer.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Bambu Studio` | `STL scaling` | `Slicer config`
...
### Core Concept
STL orientation scaling parameters inside slicer.

### Component Specifications
* **Key Device:** Bambu Studio CAD import
* **Usage Parameter:** Bambu Studio / STL scaling / Slicer config
