# Session 08: Gyroid infill structure

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Gyroid infill structure](https://images.unsplash.com/photo-1517055720413-77a282b11dd9?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Infill pattern strength density comparisons tests.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Gyroid infill` | `Strength test` | `Density check`
...
### Core Concept
Infill pattern strength density comparisons tests.

### Component Specifications
* **Key Device:** Gyroid infill structure
* **Usage Parameter:** Gyroid infill / Strength test / Density check
...
**Q2.** What is the purpose of `Gyroid infill`?
