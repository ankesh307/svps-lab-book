# Session 03: Python Indentation syntax

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Python Indentation syntax](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Understand code blocks indentation, loops scope guidelines.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Indentation` | `Blocks` | `Syntax errors`
...
### Core Concept
Understand code blocks indentation, loops scope guidelines.

### Component Specifications
* **Key Device:** Python Indentation syntax
* **Usage Parameter:** Indentation / Blocks / Syntax errors
...
**Q2.** What is the purpose of `Indentation`?
