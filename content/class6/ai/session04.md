# Session 04: Python Loops iterations

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Python Loops iterations](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Write loops repeating actions, counters parameters tracking.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Loops` | `while loop` | `for range`
...
### Core Concept
Write loops repeating actions, counters parameters tracking.

### Component Specifications
* **Key Device:** Python Loops iterations
* **Usage Parameter:** Loops / while loop / for range
...
**Q2.** What is the purpose of `Loops`?
