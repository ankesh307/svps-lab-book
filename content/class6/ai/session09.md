# Session 09: GCode file parameters

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![GCode file parameters](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Gcode commands syntax check coordinate mapping.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Gcode parameters` | `Syntax check` | `Coordinates`
...
### Core Concept
Gcode commands syntax check coordinate mapping.

### Component Specifications
* **Key Device:** GCode file parameters
* **Usage Parameter:** Gcode parameters / Syntax check / Coordinates
...
**Q2.** What is the purpose of `Gcode parameters`?
