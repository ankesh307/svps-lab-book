# Session 17: Angle mathematical mapping

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Angle mathematical mapping](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Calculating tilt degrees using basic trigonometrical math.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Angle math` | `Trigonometry` | `Tilt calculation`
...
### Core Concept
Calculating tilt degrees using basic trigonometrical math.

### Component Specifications
* **Key Device:** Angle mathematical mapping
* **Usage Parameter:** Angle math / Trigonometry / Tilt calculation
...
**Q2.** What is the purpose of `Angle math`?
