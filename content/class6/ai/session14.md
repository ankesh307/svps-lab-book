# Session 14: SPI interface setup

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![SPI interface setup](https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Serial Peripheral Interface MISO/MOSI wiring structures.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `SPI bus` | `Interface pins` | `MISO/MOSI`
...
### Core Concept
Serial Peripheral Interface MISO/MOSI wiring structures.

### Component Specifications
* **Key Device:** SPI interface setup
* **Usage Parameter:** SPI bus / Interface pins / MISO/MOSI
