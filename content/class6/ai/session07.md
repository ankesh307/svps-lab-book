# Session 07: Slicing layer config

**Class 6 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Slicing layer config](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | 0.2mm parameters setting layer width calculations.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Layer width` | `Slicing parameters` | `Config`
...
### Core Concept
0.2mm parameters setting layer width calculations.

### Component Specifications
* **Key Device:** Slicing layer config
* **Usage Parameter:** Layer width / Slicing parameters / Config
...
**Q2.** What is the purpose of `Layer width`?
