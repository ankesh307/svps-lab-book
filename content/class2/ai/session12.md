# Session 12: Logic decision trees

**Class 2 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Logic decision trees](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Root node, branches, decision endpoints mapping.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Decision Tree` | `Branches` | `Endpoints`
...
### Core Concept
Root node, branches, decision endpoints mapping.

### Component Specifications
* **Key Device:** Logic decision trees
* **Usage Parameter:** Decision Tree / Branches / Endpoints
