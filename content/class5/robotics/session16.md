# Session 16: Header file inclusion

**Class 5 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Header file inclusion](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | #include library format and library paths directory.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `#include` | `Library Paths` | `Header`
...
### Core Concept
#include library format and library paths directory.

### Component Specifications
* **Key Device:** Header file inclusion
* **Usage Parameter:** #include / Library Paths / Header
