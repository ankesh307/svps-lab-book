# Session 25: Hand Gesture Control

**Class 5 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Hand Gesture Control](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Webcam gesture classes mapped to serial commands output.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Hand Gestures` | `Webcam Class` | `Serial output`
...
### Core Concept
Webcam gesture classes mapped to serial commands output.

### Component Specifications
* **Key Device:** Hand Gesture Control
* **Usage Parameter:** Hand Gestures / Webcam Class / Serial output
