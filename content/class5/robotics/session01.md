# Session 01: Transition to C++ Text

**Class 5 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Transition to C++ Text](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Stop using blocks! C++ compiler keywords, braces and comment... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `C++ Text` | `Braces` | `Keywords`
...
### Core Concept
Stop using blocks! C++ compiler keywords, braces and comments format.

### Component Specifications
* **Key Device:** Transition to C++ Text
* **Usage Parameter:** C++ Text / Braces / Keywords
