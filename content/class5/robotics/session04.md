# Session 04: Data Type int float bool

**Class 5 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Data Type int float bool](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Integer, Float, Boolean variables memory size and limits.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `int` | `float` | `bool` | `Data Types`
...
### Core Concept
Integer, Float, Boolean variables memory size and limits.

### Component Specifications
* **Key Device:** Data Type int float bool
* **Usage Parameter:** int / float / bool / Data Types
