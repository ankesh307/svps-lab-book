# Session 21: HC-05 Bluetooth C++ RX

**Class 5 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![HC-05 Bluetooth C++ RX](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | SoftwareSerial communication setup for bluetooth app control... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `HC-05` | `SoftwareSerial` | `Bluetooth RX`
...
### Core Concept
SoftwareSerial communication setup for bluetooth app control.

### Component Specifications
* **Key Device:** HC-05 Bluetooth C++ RX
* **Usage Parameter:** HC-05 / SoftwareSerial / Bluetooth RX
...
**Q2.** What is the purpose of `HC-05`?
