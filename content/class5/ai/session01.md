# Session 01: C++ compiler setup

**Class 5 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![C++ compiler setup](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | MinGW compilation setup, command line GCC runs.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `MinGW compiler` | `GCC command` | `Compilation`
...
### Core Concept
MinGW compilation setup, command line GCC runs.

### Component Specifications
* **Key Device:** C++ compiler setup
* **Usage Parameter:** MinGW compiler / GCC command / Compilation
...
**Q2.** What is the purpose of `MinGW compiler`?
