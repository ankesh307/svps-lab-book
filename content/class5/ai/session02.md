# Session 02: C++ standard syntax

**Class 5 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![C++ standard syntax](https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | main() function return types, scope variables print.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `main() function` | `Return` | `Variables`
...
### Core Concept
main() function return types, scope variables print.

### Component Specifications
* **Key Device:** C++ standard syntax
* **Usage Parameter:** main() function / Return / Variables
...
**Q2.** What is the purpose of `main() function`?
