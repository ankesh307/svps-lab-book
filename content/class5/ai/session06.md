# Session 06: C++ Functions & Parameter Passing

**Class 5 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![C++ Functions & Parameter Passing](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Write custom reusable functions to handle sensor reads or al... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Custom Functions` | `Parameters` | `Return Types`
...
### Core Concept
Write custom reusable functions to handle sensor reads or alerts.

### Component Specifications
* **Key Device:** C++ Functions & Parameter Passing
* **Usage Parameter:** Custom Functions / Parameters / Return Types
