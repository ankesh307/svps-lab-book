# Session 17: If-else score target

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![If-else score target](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | IF score == 10 THEN next level backdrop switch.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `If-else` | `Score Target` | `Backdrop Switch`
...
### Core Concept
IF score == 10 THEN next level backdrop switch.

### Component Specifications
* **Key Device:** If-else score target
* **Usage Parameter:** If-else / Score Target / Backdrop Switch
