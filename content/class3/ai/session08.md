# Session 08: Touching Sprite logic

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Touching Sprite logic](https://images.unsplash.com/photo-1517055720413-77a282b11dd9?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | IF touching apple THEN reset apple, add score.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Touching Sensor` | `Collision` | `Score Add`
...
### Core Concept
IF touching apple THEN reset apple, add score.

### Component Specifications
* **Key Device:** Touching Sprite logic
* **Usage Parameter:** Touching Sensor / Collision / Score Add
...
**Q2.** What is the purpose of `Touching Sensor`?
