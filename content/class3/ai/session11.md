# Session 11: Scratch Backdrop draw

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Scratch Backdrop draw](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Drawing maze path borders, color fill brush tool.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Backdrop Draw` | `Maze Path` | `Brush Tool`
...
### Core Concept
Drawing maze path borders, color fill brush tool.

### Component Specifications
* **Key Device:** Scratch Backdrop draw
* **Usage Parameter:** Backdrop Draw / Maze Path / Brush Tool
...
**Q2.** What is the purpose of `Backdrop Draw`?
