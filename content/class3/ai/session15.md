# Session 15: Scratch Pen draw tool

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Scratch Pen draw tool](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Draw shapes and paths dynamically on screen using pen.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Pen Extension` | `Drawing` | `Canvas`
...
### Core Concept
Draw shapes and paths dynamically on screen using pen.

### Component Specifications
* **Key Device:** Scratch Pen draw tool
* **Usage Parameter:** Pen Extension / Drawing / Canvas
