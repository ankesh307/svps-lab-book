...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Drawing lines dynamically on cat movements shapes.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Pen Tool` | `Drawing Lines` | `Shapes`
...
### Core Concept
Drawing lines dynamically on cat movements shapes.

### Component Specifications
* **Key Device:** Scratch Pen draw tool
* **Usage Parameter:** Pen Tool / Drawing Lines / Shapes
...
**Q2.** What is the purpose of `Pen Tool`?
