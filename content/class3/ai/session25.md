# Session 25: Hand Gesture mappings

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Hand Gesture mappings](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Left, Right hand states mapping Scratch sprite.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Hand Gestures` | `Sprite Control` | `Classification`
...
### Core Concept
Left, Right hand states mapping Scratch sprite.

### Component Specifications
* **Key Device:** Hand Gesture mappings
* **Usage Parameter:** Hand Gestures / Sprite Control / Classification
