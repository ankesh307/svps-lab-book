# Session 18: Random range pick block

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Random range pick block](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | pick random block logic boundaries selection.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `pick random` | `Random Range` | `Boundaries`
...
### Core Concept
pick random block logic boundaries selection.

### Component Specifications
* **Key Device:** Random range pick block
* **Usage Parameter:** pick random / Random Range / Boundaries
...
**Q2.** What is the purpose of `pick random`?
