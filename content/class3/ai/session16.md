# Session 16: Ask and wait input

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Ask and wait input](https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Reading user input text block save to variable.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Ask and wait` | `User Input` | `Variable Save`
...
### Core Concept
Reading user input text block save to variable.

### Component Specifications
* **Key Device:** Ask and wait input
* **Usage Parameter:** Ask and wait / User Input / Variable Save
...
**Q2.** What is the purpose of `Ask and wait`?
