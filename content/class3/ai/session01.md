# Session 01: Scratch Stage Grid

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Scratch Stage Grid](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Understanding X-axis (-240 to 240) and Y-axis (-180 to 180).... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Scratch Grid` | `X-axis` | `Y-axis`
...
### Core Concept
Understanding X-axis (-240 to 240) and Y-axis (-180 to 180).

### Component Specifications
* **Key Device:** Scratch Stage Grid
* **Usage Parameter:** Scratch Grid / X-axis / Y-axis
...
**Q2.** What is the purpose of `Scratch Grid`?
