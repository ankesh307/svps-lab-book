# Session 19: Timer countdown block

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Timer countdown block](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Create timer countdown variable decrease count loop.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Timer` | `Countdown` | `Variable Dec`
...
### Core Concept
Create timer countdown variable decrease count loop.

### Component Specifications
* **Key Device:** Timer countdown block
* **Usage Parameter:** Timer / Countdown / Variable Dec
...
**Q2.** What is the purpose of `Timer`?
