# Session 09: Score variable block

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Score variable block](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Create variable score, initialize to 0 on start.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Variables` | `Score Variable` | `Set Score`
...
### Core Concept
Create variable score, initialize to 0 on start.

### Component Specifications
* **Key Device:** Score variable block
* **Usage Parameter:** Variables / Score Variable / Set Score
