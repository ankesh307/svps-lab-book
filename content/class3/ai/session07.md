# Session 07: Sprite clone block

**Class 3 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Sprite clone block](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Creating 50 star particles clones on screen.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Cloning` | `Star Clones` | `Particles`
...
### Core Concept
Creating 50 star particles clones on screen.

### Component Specifications
* **Key Device:** Sprite clone block
* **Usage Parameter:** Cloning / Star Clones / Particles
...
**Q2.** What is the purpose of `Cloning`?
