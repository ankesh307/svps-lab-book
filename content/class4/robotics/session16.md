# Session 16: PWM Output Dimming

**Class 4 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![PWM Output Dimming](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Pin A0 values coordinate karke PWM pin LED brightness smooth... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `PWM pin` | `Dimming` | `analogWrite`
...
### Core Concept
Pin A0 values coordinate karke PWM pin LED brightness smoothly map.

### Component Specifications
* **Key Device:** PWM Output Dimming
* **Usage Parameter:** PWM pin / Dimming / analogWrite
...
**Q2.** What is the purpose of `PWM pin`?
