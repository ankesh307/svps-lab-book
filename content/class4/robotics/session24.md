# Session 24: LCD 1602 I2C Pins

**Class 4 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![LCD 1602 I2C Pins](https://images.unsplash.com/photo-1565814636199-ae8133055c1c?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | SDA, SCL, VCC aur GND pins setup with I2C address map.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `I2C LCD` | `SDA/SCL` | `Address Map`
...
### Core Concept
SDA, SCL, VCC aur GND pins setup with I2C address map.

### Component Specifications
* **Key Device:** LCD 1602 I2C Pins
* **Usage Parameter:** I2C LCD / SDA/SCL / Address Map
...
**Q2.** What is the purpose of `I2C LCD`?
