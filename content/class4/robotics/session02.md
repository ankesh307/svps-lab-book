# Session 02: Current Flow Loops

**Class 4 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Current Flow Loops](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Resistors ke sath simple current loops create karke breadboa... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Current Loop` | `Resistor` | `Wiring`
...
### Core Concept
Resistors ke sath simple current loops create karke breadboard test karo.

### Component Specifications
* **Key Device:** Current Flow Loops
* **Usage Parameter:** Current Loop / Resistor / Wiring
...
**Q2.** What is the purpose of `Current Loop`?
