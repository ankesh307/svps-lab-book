...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Understand complete loops, series junctions, and resistance ... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Circuits` | `Loops` | `Current Flow`
...
### Core Concept
Understand complete loops, series junctions, and resistance path loops.

### Component Specifications
* **Key Device:** Current Flow Loops
* **Usage Parameter:** Circuits / Loops / Current Flow
...
**Q2.** What is the purpose of `Circuits`?
