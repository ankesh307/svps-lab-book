# Session 13: mBlock Hand Gesture Controller

**Class 4 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![mBlock Hand Gesture Controller](https://images.unsplash.com/photo-1516116211223-5c359a36298a?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Use webcam gesture recognition to control sprite coordinates... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Hand Gestures` | `Webcam Tracker` | `Coord Control`
...
### Core Concept
Use webcam gesture recognition to control sprite coordinates.

### Component Specifications
* **Key Device:** mBlock Hand Gesture Controller
* **Usage Parameter:** Hand Gestures / Webcam Tracker / Coord Control
