# Session 30: Showcase exhibition model

**Class 7 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Showcase exhibition model](https://images.unsplash.com/photo-1565814636199-ae8133055c1c?w=800&auto=format&fit=crop&q=80)

> **Session 30** | 80 Minutes | AI Track
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Self running AI classification logic display.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Showcase` | `AI Display` | `Exhibition`
...
### Core Concept
Self running AI classification logic display.

### Component Specifications
* **Key Device:** Showcase exhibition model
* **Usage Parameter:** Showcase / AI Display / Exhibition
