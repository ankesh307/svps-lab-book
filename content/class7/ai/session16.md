# Session 16: OpenCV Video Capture

**Class 7 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![OpenCV Video Capture](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Frame capture loop scale resize python OpenCV.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `cv2.VideoCapture` | `OpenCV Frame` | `Python loop`
...
### Core Concept
Frame capture loop scale resize python OpenCV.

### Component Specifications
* **Key Device:** OpenCV Video Capture
* **Usage Parameter:** cv2.VideoCapture / OpenCV Frame / Python loop
...
**Q2.** What is the purpose of `cv2.VideoCapture`?
