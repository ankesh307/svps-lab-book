# Session 10: IMU roll pitch angles

**Class 7 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![IMU roll pitch angles](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Convert accelerometer raw values to angular coordinates.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `IMU coordinates` | `Roll/Pitch angles` | `Math map`
...
### Core Concept
Convert accelerometer raw values to angular coordinates.

### Component Specifications
* **Key Device:** IMU roll pitch angles
* **Usage Parameter:** IMU coordinates / Roll/Pitch angles / Math map
...
**Q2.** What is the purpose of `IMU coordinates`?
