# Session 17: HSV segmentation mask

**Class 7 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![HSV segmentation mask](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Filter pixels by color thresholds to detect target objects.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `HSV filter` | `Color mask` | `cv2.inRange()`
...
### Core Concept
Filter pixels by color thresholds to detect target objects.

### Component Specifications
* **Key Device:** HSV segmentation mask
* **Usage Parameter:** HSV filter / Color mask / cv2.inRange()
...
**Q2.** What is the purpose of `HSV filter`?
