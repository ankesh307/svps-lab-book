# Session 12: Camera Gimbal servos map

**Class 7 – AI TRACK**  
Tier Curriculum | Connect Shiksha

![Camera Gimbal servos map](https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Mount camera systems and balance horizon tilts using servos.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Gimbal servo` | `Horizon balance` | `MPU6050 lock`
...
### Core Concept
Mount camera systems and balance horizon tilts using servos.

### Component Specifications
* **Key Device:** Camera Gimbal servos map
* **Usage Parameter:** Gimbal servo / Horizon balance / MPU6050 lock
...
**Q2.** What is the purpose of `Gimbal servo`?
