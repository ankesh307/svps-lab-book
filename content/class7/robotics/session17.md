# Session 17: Delta Cloud uploading

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Delta Cloud uploading](https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Batch transfer local sensor databases to server databases.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Batch upload` | `Data transfer` | `Server logs`
...
### Core Concept
Batch transfer local sensor databases to server databases.

### Component Specifications
* **Key Device:** Delta Cloud uploading
* **Usage Parameter:** Batch upload / Data transfer / Server logs
...
**Q2.** What is the purpose of `Batch upload`?
