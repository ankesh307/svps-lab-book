# Session 17: Warehouse Delivery Bot
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | RFID cards coordinate parsing on floor navigate paths.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `RFID Navigate` | `Delivery Bot` | `Warehouse`
...
### Core Concept
RFID cards coordinate parsing on floor navigate paths.

### Component Specifications
* **Key Device:** Warehouse Delivery Bot
* **Usage Parameter:** RFID Navigate / Delivery Bot / Warehouse
...
**Q2.** What is the purpose of `RFID Navigate`?
