# Session 02: ThingSpeak Channel API

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![ThingSpeak Channel API](https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80)
...
**Keywords:** `ThingSpeak` | `Channel API` | `Write Key`
...
* **Usage Parameter:** ThingSpeak / Channel API / Write Key
...
**Q2.** What is the purpose of `ThingSpeak`?
