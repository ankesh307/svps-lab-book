# Session 22: ESP8266 Deep Sleep mode

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![ESP8266 Deep Sleep mode](https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | ESP.deepSleep() wake timer configuration via D0 pin.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `ESP.deepSleep()` | `Wake Timer` | `D0 Jumper`
...
### Core Concept
ESP.deepSleep() wake timer configuration via D0 pin.

### Component Specifications
* **Key Device:** ESP8266 Deep Sleep mode
* **Usage Parameter:** ESP.deepSleep() / Wake Timer / D0 Jumper
...
**Q2.** What is the purpose of `ESP.deepSleep()`?
