# Session 18: Tilt Glove control logic
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Use gyro sensors to control robotic cars with hand tilts.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Glove control` | `MPU6050 gyro` | `Remote drive`
...
### Core Concept
Use gyro sensors to control robotic cars with hand tilts.

### Component Specifications
* **Key Device:** Tilt Glove control logic
* **Usage Parameter:** Glove control / MPU6050 gyro / Remote drive
...
**Q2.** What is the purpose of `Glove control`?
