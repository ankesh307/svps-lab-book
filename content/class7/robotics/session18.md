# Session 18: Delta Cloud uploading
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Only upload values to cloud if value changes > threshold.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Delta upload` | `Bandwidth save` | `Threshold`
...
### Core Concept
Only upload values to cloud if value changes > threshold.

### Component Specifications
* **Key Device:** Delta Cloud uploading
* **Usage Parameter:** Delta upload / Bandwidth save / Threshold
...
**Q2.** What is the purpose of `Delta upload`?
