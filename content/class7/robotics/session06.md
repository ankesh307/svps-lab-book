# Session 06: RFID Google Sheets Log

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![RFID Google Sheets Log](https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | RFID swipe sends post request to IFTTT sheets applet.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `RFID Sheets` | `Google Log` | `IFTTT Applet`
...
### Core Concept
RFID swipe sends post request to IFTTT sheets applet.

### Component Specifications
* **Key Device:** RFID Google Sheets Log
* **Usage Parameter:** RFID Sheets / Google Log / IFTTT Applet
...
**Q2.** What is the purpose of `RFID Sheets`?
