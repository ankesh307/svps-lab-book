# Session 23: ESP-NOW Mesh routing

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![ESP-NOW Mesh routing](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | 4 nodes passing payload data from station to gateway.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Mesh network` | `Mesh routing` | `ESP-NOW`
...
### Core Concept
4 nodes passing payload data from station to gateway.

### Component Specifications
* **Key Device:** ESP-NOW Mesh routing
* **Usage Parameter:** Mesh network / Mesh routing / ESP-NOW
...
**Q2.** What is the purpose of `Mesh network`?
