# Session 27: HSV Color segmentation

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![HSV Color segmentation](https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Converting frame to HSV mask values to track color.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `HSV mask` | `cv2.inRange` | `Color segment`
...
### Core Concept
Converting frame to HSV mask values to track color.

### Component Specifications
* **Key Device:** HSV Color segmentation
* **Usage Parameter:** HSV mask / cv2.inRange / Color segment
...
**Q2.** What is the purpose of `HSV mask`?
