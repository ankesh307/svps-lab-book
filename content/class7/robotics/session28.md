# Session 28: Object Contour Tracking

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![Object Contour Tracking](https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | cv2.findContours, drawing bounding circle coordinates.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `Contours` | `cv2.findContours` | `Bounding box`
...
### Core Concept
cv2.findContours, drawing bounding circle coordinates.

### Component Specifications
* **Key Device:** Object Contour Tracking
* **Usage Parameter:** Contours / cv2.findContours / Bounding box
...
**Q2.** What is the purpose of `Contours`?
