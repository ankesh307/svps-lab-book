# Session 21: ArduinoOTA Update loop

**Class 7 – ROBOTICS TRACK**  
Tier Curriculum | Connect Shiksha

![ArduinoOTA Update loop](https://images.unsplash.com/photo-1553406830-ef2513677491?w=800&auto=format&fit=crop&q=80)
...
| Time | Activity | Focus |
|:---|:---|:---|
| **0-20 min** | Theory | Wireless code flashing setup using OTA software port.... |
| **20-65 min** | Practical Lab | Hands-on building and testing |
| **65-75 min** | Debug & Fix | Troubleshoot and improve |
| **75-80 min** | Quick Quiz | 3-question knowledge check |

**Keywords:** `OTA Update` | `ArduinoOTA` | `Wireless upload`
...
### Core Concept
Wireless code flashing setup using OTA software port.

### Component Specifications
* **Key Device:** ArduinoOTA Update loop
* **Usage Parameter:** OTA Update / ArduinoOTA / Wireless upload
...
**Q2.** What is the purpose of `OTA Update`?
